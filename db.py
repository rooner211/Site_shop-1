...
def fill_products():
    products_data = [
        ...
        {"name": "Resident Evil Village", "price": 49.99,
         "description": "Experience survival horror like never before in the eighth major installment in the Resident"
                        "Evil series.",
        ...
        {"name": "The Witcher 3: Wild Hunt", "price": 29.99,
         "description": "Become a monster slayer for hire and embark on an epic journey to track down the child of"
                        "prophecy.",
        ...
        {"name": "Minecraft", "price": 26.95,
         "description": "Explore infinite worlds and build everything from the simplest of homes to the grandest of "
        ...
        {"name": "Grand Theft Auto V", "price": 29.99,
         "description": "Enter the lives of three very different criminals, Michael, Franklin, and Trevor, "
                        "as they risk everything in a series of daring and dangerous heists that could set them up "
                        "for life.",
         "image": "gta_v.jpg", "stock": 70, "category_id": 4},
        {"name": "Red Dead Redemption 2", "price": 39.99,
         "description": "America, 1899. The end of the Wild West era has begun. After a robbery goes badly wrong in "
        ...
        {"name": "Assassin's Creed Valhalla", "price": 49.99,
         "description": "Become Eivor, a legendary Viking raider, and lead your clan from the harsh shores of Norway "
                        "to a new home amid the lush farmlands of ninth-century England.",
        ...
        {"name": "Cyberpunk 2077", "price": 59.99,
         "description": "Enter the world of Cyberpunk 2077 - a story-driven, open world RPG of the dark future from "
                        "CD PROJEKT RED.",
        ...
        {"name": "Death Stranding", "price": 39.99,
         "description": "From legendary game creator Hideo Kojima comes an all-new, genre-defying experience for the "
                        "PlayStation®4.",
        ...
        {"name": "The Elder Scrolls V: Skyrim", "price": 39.99,
         "description": "Winner of more than 200 Game of the Year Awards, Skyrim Special Edition brings the epic "
                        "fantasy to life in stunning detail.",
        ...
        {"name": "Apex Legends", "price": 0.00,
         "description": "Conquer with character in Apex Legends, a free-to-play* Battle Royale shooter where "
                        "legendary characters with powerful abilities team up to battle for fame and fortune on the "
